  ...
  try {
    ...
    return (
        ...
        <>
            <Helmet>
                <title>
                    Data Entry Remote Job 2026 | Work From Home Data Entry Jobs | Nexify Media
                </title>

                <meta
                    name="description"
                    content="Apply for Remote Data Entry Jobs at Nexify Media. Work from home data entry opportunities for freshers and experienced candidates. Flexible schedules, online data entry work, part-time and full-time remote jobs available."
                />
                ...
                <meta
                    ...
                    content="Join Nexify Media as a Remote Data Entry Executive. Flexible work from home opportunities for freshers and experienced candidates."
                />
                ...
                <link
                    rel="canonical"
                    href="https://nexifymedia.co.in/careers/data-entry-remote-job"
                />
            </Helmet>
            <Navigation />
            ...
            <section className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 pt-36 pb-24">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <p className="text-xl text-slate-300 max-w-3xl">
                        Join Nexify Media as a Remote Data Entry Executive and work
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="bg-white rounded-3xl p-8 shadow-sm">
                                ...
                                <p className="text-slate-600 leading-8">
                                    Nexify Media is looking for detail-oriented individuals
            ...
            <section className="bg-white rounded-3xl shadow-sm p-8 mt-8">
                ...
                <p className="text-slate-700 leading-8 mb-4">
                    Looking for remote data entry jobs? Nexify Media offers work from home
                    data entry opportunities for candidates who want flexible online work.
                ...
                <div className="space-y-6">
                    <div>
                        <h3 className="font-semibold text-xl">
                            Is this a work from home data entry job?
                        </h3>
                        <p className="text-slate-700 mt-2">
                            Yes, this is a fully remote data entry position allowing candidates
                            to work from home.
                        </p>
                    </div>
