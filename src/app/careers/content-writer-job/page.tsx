  ...
  try {
    ...
    return (
        ...
        <>
            <Helmet>
                <title>
                    Content Writer Job 2026 | Work From Home Content Writing Jobs | Nexify Media
                </title>

                <meta
                    name="description"
                    content="Apply for Remote Content Writing Jobs at Nexify Media. Work from home content writing opportunities for freshers and experienced candidates. Flexible schedules, online content writing work, part-time and full-time remote jobs available."
                />
                ...
                <meta
                    ...
                    content="Join Nexify Media as a Remote Content Writer. Flexible work from home opportunities for freshers and experienced candidates."
                />
            ...
            <section className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 pt-36 pb-24">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <p className="text-xl text-slate-300 max-w-3xl">
                        Join Nexify Media as a Remote Content Writer and work
          ...
          Apply Now
            ...
            <section className="bg-white rounded-3xl shadow-sm p-8 mt-8">
                ...
                <p className="text-slate-700 leading-8 mb-4">
                    Looking for remote Content Writer jobs? Nexify Media offers work from home
