  ...
  try {
    ...
    return (
        ...
        <>
            <Helmet>
                <title>
                    SEO Executive Job 2026 | Work From Home SEO Executive Jobs | Nexify Media
                </title>

                <meta
                    name="description"
                    content="Apply for Remote SEO Executive Jobs at Nexify Media. Work from home SEO Executive opportunities for freshers and experienced candidates. Flexible schedules, online SEO Executive work, part-time and full-time remote jobs available."
                />
                ...
                <meta
                    ...
                    content="Join Nexify Media as a SEO Executive. Flexible work from home opportunities for freshers and experienced candidates."
                />
                ...
                <link
                    rel="canonical"
                    href="https://nexifymedia.co.in/careers/content-writer-job"
                />
            </Helmet>
            <Navigation />
            ...
            <section className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 pt-36 pb-24">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <p className="text-xl text-slate-300 max-w-3xl">
                        Join Nexify Media as a SEO Executive and work
...
<div>
  ...
  <h3 className="font-bold text-xl">₹10K - ₹25K</h3>
</div>
                            <button
                                type="button"
  ...
  Nexify Media is looking for passionate SEO Executives who
  ...
  <li>🤝 Supportive Team Environment</li>
            ...
            <section className="bg-white rounded-3xl shadow-sm p-8 mt-8">
                ...
                <p className="text-slate-700 leading-8 mb-4">
                    Looking for remote SEO Executive Jobs? Nexify Media offers work from home
