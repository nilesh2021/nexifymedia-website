      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-8">
            ...
            NexifyMedia website and services.
          </p>
        ...
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              All information provided on the NexifyMedia website is published
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              NexifyMedia provides digital marketing, SEO, branding, web
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              ...
              services. NexifyMedia does not guarantee the accuracy,
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              ...
              links. This means NexifyMedia may earn a commission if users
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              NexifyMedia shall not be held liable for any losses, damages, or
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              NexifyMedia reserves the right to update or modify this
