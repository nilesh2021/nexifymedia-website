      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-8">
            ...
            NexifyMedia’s website and digital services.
          </p>
        ...
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              By accessing and using the NexifyMedia website, you agree to
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              ...
              available on NexifyMedia are the intellectual property of
              NexifyMedia unless otherwise stated. Unauthorized use or
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              NexifyMedia provides digital marketing, SEO, web design, content,
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              ...
              NexifyMedia is not responsible for the content, policies, or
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              NexifyMedia shall not be held liable for any direct, indirect,
