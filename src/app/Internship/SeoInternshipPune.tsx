  ...
  return (
    ...
    <>
      ...
      <Helmet>
        ...
        <title>
          SEO Internship in Pune | Digital Marketing Internship | NexifyMedia
        </title>

        <meta
          name="description"
          content="Apply for SEO Internship in Pune at NexifyMedia. Learn keyword research, on-page SEO, Google Analytics, Search Console, and digital marketing strategies with practical projects."
        />
    ...
    "
        ...
        <meta
          property="og:title"
          content="SEO Internship in Pune | NexifyMedia"
        />

        <meta
          property="og:description"
          content="Join NexifyMedia SEO Internship Program in Pune and gain practical digital marketing experience."
        />
        ...
        <meta
          property="og:url"
          content="https://nexifymedia.co.in/seo-internship-pune"
        />

        <link
          rel="canonical"
          href="https://nexifymedia.co.in/seo-internship-pune"
        />
