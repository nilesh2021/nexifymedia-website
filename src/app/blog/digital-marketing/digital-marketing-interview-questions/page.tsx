...
export default function DigitalMarketingInterviewQuestionsPage() {
  return (
    <>
      <Helmet>
        <title>
          Digital Marketing Interview Questions for Internship | Nexify Media
        </title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://www.nexifymedia.co.in/blog/digital-marketing/digital-marketing-interview-questions"
        />
        <meta
          property="og:title"
        ...
        <meta
          property="og:url"
          content="https://www.nexifymedia.co.in/blog/digital-marketing/digital-marketing-interview-questions"
        />
