...
export default function WhatIsSeoPage() {
  return (
    <>
      <Helmet>
        <title>What is SEO? | Search Engine Optimization Basics | Nexify Media</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://www.nexifymedia.co.in/blog/seo/what-is-seo"
        />
        <meta
          property="og:title"
        ...
        <meta
          property="og:url"
          content="https://www.nexifymedia.co.in/blog/seo/what-is-seo"
        />
            ...
            <aside className="sticky top-24 h-fit">
              <div className="rounded-[32px] border border-white/10 bg-white/5 p-8">
                ...
                <p className="mt-4 text-gray-300 leading-7">
                  Learn the basics of search optimization and explore related SEO articles from Nexify Media.
                </p>
