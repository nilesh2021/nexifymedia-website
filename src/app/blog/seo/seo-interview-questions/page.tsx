...
export default function SeoInterviewQuestionsPage() {
  return (
    <>
      <Helmet>
        <title>
          SEO Interview Questions (Basic & Advanced) | Nexify Media
        </title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://www.nexifymedia.co.in/blog/seo/seo-interview-questions"
        />
        <meta
          property="og:title"
        ...
        <meta
          property="og:url"
          content="https://www.nexifymedia.co.in/blog/seo/seo-interview-questions"
        />
