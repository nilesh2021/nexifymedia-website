...
export default function TechnicalSeoChecklistPage() {
  return (
    <>
      <Helmet>
        <title>Technical SEO Checklist | Nexify Media</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://www.nexifymedia.co.in/blog/seo/technical-seo-checklist"
        />
        <meta
          property="og:title"
          content="Technical SEO Checklist | Nexify Media"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.nexifymedia.co.in/blog/seo/technical-seo-checklist"
        />
